...
module.exports = {
  ...
  // 那么将这个值改为 `/my-app/`
  publicPath: '/h5resources/backstation/' /* 这个是我存放在github在线预览的Reader项目*/,

  // 将构建好的文件输出到哪里（或者说将编译的文件）
  outputDir: 'backstation',
  ...
  chainWebpack: (config) => {
    ...
    config.resolve.alias
      ...
      .set('@pop', resolve('src/components/pop'))
      .set('@ui', resolve('src/components/ui'))
      .set('@widgets', resolve('src/components/ui/widgets'))
